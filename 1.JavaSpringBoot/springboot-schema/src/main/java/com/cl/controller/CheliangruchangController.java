...
public class CheliangruchangController {
    ...
    public R page(@RequestParam Map<String, Object> params,CheliangruchangEntity cheliangruchang, 
		...
		if(tableName.equals("yezhu")) {
			cheliangruchang.setChezhu((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("wuyerenyuan")) {
			cheliangruchang.setWuyezhanghao((String)request.getSession().getAttribute("username"));
		}

...
public class CheliangchuchangController {
    ...
    public R page(@RequestParam Map<String, Object> params,CheliangchuchangEntity cheliangchuchang, 
		...
		if(tableName.equals("yezhu")) {
			cheliangchuchang.setChezhu((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("wuyerenyuan")) {
			cheliangchuchang.setWuyezhanghao((String)request.getSession().getAttribute("username"));
		}

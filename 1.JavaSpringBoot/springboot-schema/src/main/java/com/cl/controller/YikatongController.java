...
public class YikatongController {
    ...
    public R page(@RequestParam Map<String, Object> params,YikatongEntity yikatong, 
		...
		if(tableName.equals("yezhu")) {
			yikatong.setYezhuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		yikatong = yikatongService.selectView(new EntityWrapper<YikatongEntity>().eq("id", id));

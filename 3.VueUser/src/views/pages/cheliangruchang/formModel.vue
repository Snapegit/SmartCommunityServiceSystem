	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">车主</div>
					<div  class="info_text" >{{detail.chezhu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'出场')" @click="cheliangchuchangonAcross('出场','cheliangchuchang','','','')" type="warning">出场</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('cheliangruchang','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('cheliangruchang','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const cheliangchuchangonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {

			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="投诉编号" prop="tousubianhao">
						<el-input class="list_inp" v-model="form.tousubianhao" placeholder="请输入投诉编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="物业账号" prop="wuyezhanghao">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.wuyezhanghao?true:false"
							v-model="form.wuyezhanghao" 
							placeholder="请选择物业账号"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in wuyezhanghaoLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="投诉内容" prop="tousuneirong">
						<editor class="list_editor" :value="form.tousuneirong" placeholder="请输入投诉内容" :readonly="!isAdd||disabledForm.tousuneirong?true:false"
							@change="(e)=>editorChange(e,'tousuneirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.tousuneirong = res.data.data.tousuneirong.replace(reg,'../../../cl0608701/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			url: `option/wuyerenyuan/wuyezhanghao`,
			method: 'get'
		}).then(res=>{
			wuyezhanghaoLists.value = res.data.data
		})
	}
	//初始化
	//取消

		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="wuyezhanghao" label="物业账号">
								<el-input class="list_inp" v-model="userForm.wuyezhanghao" placeholder="物业账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="wuyexingming" label="物业姓名">
								<el-input class="list_inp" v-model="userForm.wuyexingming" placeholder="物业姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">

<template>
	<div class="app-contain" :style='{"width":"64%","padding":"0px 0px 10px","margin":"0px auto 40px","position":"relative","borderRadius":"20px","background":"#fff"}'>

	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">楼房号：</div>
					<input class="list_inp"
					 v-model="registerForm.loufanghao" 
					 placeholder="请输入楼房号"
					 type="text"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">车牌号：</div>
					<input class="list_inp"

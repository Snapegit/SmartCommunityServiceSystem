		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="yezhuzhanghao" label="业主账号">
								<el-input class="list_inp" v-model="userForm.yezhuzhanghao" placeholder="业主账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="yezhuxingming" label="业主姓名">
								<el-input class="list_inp" v-model="userForm.yezhuxingming" placeholder="业主姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="loudonghao" label="楼栋号">
								<el-input class="list_inp" v-model="userForm.loudonghao" placeholder="楼栋号" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="loufanghao" label="楼房号">
								<el-input class="list_inp" v-model="userForm.loufanghao" placeholder="楼房号" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="chepaihao" label="车牌号">
								<el-input class="list_inp" v-model="userForm.chepaihao" placeholder="车牌号" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">

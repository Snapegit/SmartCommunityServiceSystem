	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">车位数</div>
					<div  class="info_text" >{{detail.cheweishu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">配套实施</div>
					<div  class="info_text" >{{detail.peitaoshishi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">每小时价</div>
					<div  class="info_text" >{{detail.jiage}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">收费标准</div>
					<div  class="info_text" >{{detail.shoufeibiaozhun}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'入场')" @click="cheliangruchangonAcross('入场','cheliangruchang','','','')" type="warning">入场</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tingchechang','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tingchechang','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.tingchechangmingcheng
	...
	const cheliangruchangonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {

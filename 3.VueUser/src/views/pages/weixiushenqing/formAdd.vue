			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="报修内容" prop="baoxiuneirong">
						<editor class="list_editor" :value="form.baoxiuneirong" placeholder="请输入报修内容" :readonly="!isAdd||disabledForm.baoxiuneirong?true:false"
							@change="(e)=>editorChange(e,'baoxiuneirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.baoxiuneirong = res.data.data.baoxiuneirong.replace(reg,'../../../cl0608701/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			form.value.weixiuzhuangtai='未维修'
		}
		context?.$http({

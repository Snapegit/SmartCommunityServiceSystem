<template>
	<div class="app-contain" :style='{"padding":"0","margin":"0 auto","overflow":"hidden","borderRadius":"20px","background":"#fff","width":"64%","position":"relative"}'>
		...
		<div class="news_list_six">
			<template v-for="(item,index) in list" :key="index">
				<div class="six_item animation_box" @click.stop="newsDetail(item.id)">
					<div class="time_box">

		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			<div class="search_view">
				...
				<div class="search_box">
					<el-input class="search_inp" v-model="searchQuery.loufanghao" placeholder="楼房号"
						clearable>
					</el-input>
				</div>
			</div>
			...
			<div class="data_box">
				<div class="data_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="维修类型" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.weixiuleixing}}
							</template>
						</el-table-column>
						<el-table-column label="维修人" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.weixiuren}}
							</template>
						</el-table-column>
						...
						<el-table-column label="维修状态" :resizable='true' align="left" header-align="left">
							<template #default="scope">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/weixiuxinxiAdd')
	}
	//判断是否从个人中心跳转
	...
	const getList = () => {
		...
		if(searchQuery.value.loufanghao&&searchQuery.value.loufanghao!=''){
			params.loufanghao = '%' + searchQuery.value.loufanghao + '%'
		}
	...
	const tableDetailClick = (row) => {
		router.push('weixiuxinxiDetail?id=' + row.id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){

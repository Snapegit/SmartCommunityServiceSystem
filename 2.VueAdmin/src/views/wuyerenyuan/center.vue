				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="物业账号" prop="wuyezhanghao">
							<el-input class="list_inp" v-model="user.wuyezhanghao" readonly placeholder="物业账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="物业姓名" prop="wuyexingming">
							<el-input class="list_inp" v-model="user.wuyexingming"  placeholder="物业姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="wuyerenyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const wuyerenyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.wuyezhanghao)){

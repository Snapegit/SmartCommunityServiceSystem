				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="卡号" prop="kahao">
							<el-input class="list_inp" v-model="form.kahao" placeholder="卡号"
								 type="text" 								:readonly="!isAdd||disabledForm.kahao?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="权限信息" prop="quanxianxinxi">
							<el-input v-model="form.quanxianxinxi" placeholder="权限信息" type="textarea"
							:readonly="!isAdd||disabledForm.quanxianxinxi?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='kahao'){
					form.value.kahao = row[x];
					disabledForm.value.kahao = true;
					continue;
				}
				if(x=='shuliang'){
				...
				if(x=='quanxianxinxi'){
					form.value.quanxianxinxi = row[x];
					disabledForm.value.quanxianxinxi = true;
					continue;
				}
				if(x=='beizhu'){
	...
	const yezhuzhanghaoChange=()=>{
		context?.$http({
			...
			if(res.data.data.loudonghao){
				form.value.loudonghao = res.data.data.loudonghao
			}
			if(res.data.data.loufanghao){
				form.value.loufanghao = res.data.data.loufanghao
			}
		})
	}
	//富文本

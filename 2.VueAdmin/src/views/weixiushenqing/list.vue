			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('weixiushenqing','维修')" type="success" @click="weixiuxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">维修</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
    ...
    const weixiuxinxiCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			weixiuxinxiFormModelRef.value.init(row.id,'cross','维修',row,'weixiushenqing',statusColumnName,tips,statusColumnValue)
		})
    }
	//初始化
	const init = () => {
